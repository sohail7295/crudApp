pipeline {
  ...
  stages {
    ...
    stage ('Run Build') {
     ...
     stage ('Nexus') {
      steps {
      nexusArtifactUploader artifacts: [[artifactId: 'crudApp', classifier: '', file: 'target/crudApp.war', type: 'war']], credentialsId: 'nexus', groupId: 'Central', nexusUrl: '3.17.203.182:8081/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'releases', version: '2.6'
      }
    }
