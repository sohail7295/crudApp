pipeline {
  ...
  stages {
    ...
    stage ('Copy to tomcat') {
      steps {
        sh "sudo wget http://3.17.203.182:8081/nexus/service/local/repositories/releases/content/Central/crudApp/2.7/crudApp-2.7.war -O /opt/apache-tomcat-9.0.14/webapps/crudApp.war"
