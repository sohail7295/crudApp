pipeline {
  ...
  stages {
    ...
    stage ('Copy to tomcat') {
      steps {
        sh "sudo wget http://18.224.214.79:8081/nexus/service/local/repositories/releases/content/Central/crudApp/3.4/crudApp-3.4.war -O /opt/apache-tomcat-9.0.14/webapps/crudApp.war"
